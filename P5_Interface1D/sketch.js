...
function setup() {
  ...
  playerOne = new Player(color(180,255,255), parseInt(random(0,displaySize)), displaySize);   // Initializing players
  playerTwo = new Player(color(0,160,255), parseInt(random(0,displaySize)), displaySize);
